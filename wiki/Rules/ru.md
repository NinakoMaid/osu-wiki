...
1.  **Каждый игрок имеет право только на *ОДИН* аккаунт.** Этот аккаунт является вашим лицом, им не должен пользоваться кто-либо другой, включая ваших друзей и семью. Не надо создавать новый, если вы потеряли к нему доступ. Берегите его.
...
7.  **Ссылки не должны вести на пиратские сайты.** В чат запрещено кидать торрент-трекеры и сайты с нелегальным контентом. Реклама Twitch-канала с играми, не связанными с osu!, разрешена только в `#videogames`.
